...
public:
  ...
  static Clock::TimePoint time(Clock::Id id) {
    Clock::TimePoint tp{};
#ifdef _WIN32
    switch (id) {
    case Clock::Id::Real:
  ...
  static Clock::TimePoint real() { return time(Clock::Id::Real); }
  static Clock::TimePoint monotonic() { return time(Clock::Id::Monotonic); }
